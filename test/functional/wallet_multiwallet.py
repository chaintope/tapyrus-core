...
class MultiWalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        w5 = wallet("w5")
        w5.generate(1, self.signblockprivkeys)
        ...
        wallets[0].generate(1, self.signblockprivkeys)
        ...
        w1.generate(101, self.signblockprivkeys)
        ...
        w1.generate(1, self.signblockprivkeys)
