...
class MerkleBlockTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].generate(105, self.signblockprivkeys)
        self.sync_all()
        ...
        txid1 = self.nodes[0].sendrawtransaction(self.nodes[0].signrawtransactionwithwallet(tx1, [], "ALL", self.options.scheme)["hex"])
        tx2 = self.nodes[0].createrawtransaction([node0utxos.pop()], {self.nodes[1].getnewaddress(): 49.99})
        txid2 = self.nodes[0].sendrawtransaction(self.nodes[0].signrawtransactionwithwallet(tx2, [], "ALL", self.options.scheme)["hex"])
        ...
        txid3 = self.nodes[0].sendrawtransaction(self.nodes[1].signrawtransactionwithwallet(tx3, [], "ALL", self.options.scheme)["hex"])
        self.nodes[0].generate(1, self.signblockprivkeys)
        self.sync_all()
