...
class SegWitTest(BitcoinTestFramework):
    ...
    def test_unnecessary_witness_before_segwit_activation(self):
        ...
        tx = CTransaction()
        tx.vin.append(CTxIn(COutPoint(self.utxo[0].malfixsha256, self.utxo[0].n), b""))
    ...
    def test_v0_outputs_arent_spendable(self):
        ...
        tx = CTransaction()
        tx.vin = [CTxIn(COutPoint(self.utxo[0].malfixsha256, self.utxo[0].n), b'')]
    ...
    def test_standardness_v0(self):
        ...
        p2sh_tx.vin = [CTxIn(COutPoint(self.utxo[0].malfixsha256, self.utxo[0].n), b"")]
    ...
    def test_witness_block_size(self):
        ...
        prevout = COutPoint(self.utxo[0].malfixsha256, self.utxo[0].n)
    ...
    def test_segwit_versions(self):
        ...
        total_value = 0
        for i in temp_utxo:
            tx3.vin.append(CTxIn(COutPoint(i.malfixsha256, i.n), b""))
            tx3.wit.vtxinwit.append(CTxInWitness())
    ...
    def test_uncompressed_pubkey(self):
        ...
        tx = CTransaction()
        tx.vin.append(CTxIn(COutPoint(utxo.malfixsha256, utxo.n), b""))
    ...
    def test_signature_version_1(self):
        ...
        for sigflag in [0, SIGHASH_ANYONECANPAY]:
            for hashtype in [SIGHASH_ALL, SIGHASH_NONE, SIGHASH_SINGLE]:
                ...
                block = self.build_next_block()
                tx = CTransaction()
                tx.vin.append(CTxIn(COutPoint(prev_utxo.malfixsha256, prev_utxo.n), b""))
        ...
        for i in range(NUM_SIGHASH_TESTS):
            ...
            for i in range(num_inputs):
                tx.vin.append(CTxIn(COutPoint(temp_utxos[i].malfixsha256, temp_utxos[i].n), b""))
                tx.wit.vtxinwit.append(CTxInWitness())
        ...
        script_pkh = CScript([OP_0, pubkeyhash])
        tx = CTransaction()
        tx.vin.append(CTxIn(COutPoint(temp_utxos[0].malfixsha256, temp_utxos[0].n), b""))
        ...
        for i in temp_utxos:
            ...
            tx.vin.append(CTxIn(COutPoint(i.malfixsha256, i.n), b""))
            tx.wit.vtxinwit.append(CTxInWitness())
