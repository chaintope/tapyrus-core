...
Modified from schnorr.py from https://github.com/Bitcoin-ABC/bitcoin-abc
"""
...
ssl = ctypes.cdll.LoadLibrary(ctypes.util.find_library ('ssl') or ctypes.util.find_library ('openssl@3') or 'libeay32')
