...
ssl.BN_bn2bin.restype = ctypes.c_void_p
ssl.BN_bn2bin.argtypes = [ctypes.c_void_p, ctypes.c_char_p]
...
class Schnorr(CECKey):
    ...
    def _jacobi(self, a, n):
        ...
        if n & 3 == 3 and a1 & 3 == 3:
            s = -s
        return s * self._jacobi(n % a1, a1)


    def _nonce_function_rfc6979(self,  msg32, algo16=b'', ndata=b''):
        ...
        blob = bytes(self.privkeybytes) + msg32 + ndata + algo16
        # initialize
    ...
    def set_secretbytes(self, secret):
        self.privkeybytes = ssl.BN_bin2bn(secret, 32, None).to_bytes(32, 'big')

    def set_privkey(self, key):
        assert len(key) == 32
        self.privkeybytes = key

    def get_privkey(self):
        return self.privkeybytes
...
if __name__ == '__main__':
    ...
    sigObj = Schnorr()
    sigObj.set_privkey(bytes.fromhex("12b004fff7f4b69ef8650e767f18f11ede158148b425660723b9f9a66e61f747"))

    pubkey = sigObj.get_pubkey(True)
