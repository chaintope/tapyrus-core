...
TAPYRUSD_PROC_TIMEOUT = 360 # time to wait for tapyrusd to start
TAPYRUSD_MESSAGE_TIMEOUT = 60 # time to wait for a response from tapyrusd
TAPYRUSD_MIN_TIMEOUT = 5 # a minimumtime to wait
TAPYRUSD_SYNC_TIMEOUT = 600 # time for multiple nodes to sync
