...
class SendHeadersTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        test_node = self.nodes[0].add_p2p_connection(BaseNode(self.nodes[0].time_to_connect), services=NODE_UNSUPPORTED_FEATURE, wait_for_verack=False)
