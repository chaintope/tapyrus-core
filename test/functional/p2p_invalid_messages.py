...
class InvalidMessagesTest(BitcoinTestFramework):
    ...
    def test_invalid_pow_headers_msg(self):
        ...
        blockheader_tip = FromHex(CBlockHeader(), self.nodes[0].getblockheader(blockheader_tip_hash, False))
    ...
    def test_noncontinuous_headers_msg(self):
        ...
        for block_hash in block_hashes:
            block_headers.append(FromHex(CBlockHeader(), self.nodes[0].getblockheader(block_hash, False)))
