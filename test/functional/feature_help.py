...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start tapyrus with -h for help text")
        ...
        self.log.info("Start tapyrus with -version for version information")
        ...
        self.log.info("Start tapyrusd with -fakearg to make sure it does not start")
