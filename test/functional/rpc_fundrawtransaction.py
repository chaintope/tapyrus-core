...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "changeAddress must be a valid tapyrus address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
        ...
        assert_raises_rpc_error(-5, "Unknown change type 'bech32'", self.nodes[2].fundrawtransaction, rawtx, {'change_type' : "bech32"})
        ...
        self.sync_all()
        new_block = self.nodes[1].generate(1, self.signblockprivkey_wif)[0]
        self.sync_all()
        ...
        print("%s\n%s\n" % (blockData, self.nodes[1].gettransaction(blockData['tx'][0])))
        ...
        signedtx = self.nodes[3].signrawtransactionwithwallet(result["hex"], [], "ALL", self.options.scheme)
