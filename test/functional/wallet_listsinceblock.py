...
class ListSinceBlockTest (BitcoinTestFramework):
    ...
    def test_no_blockhash(self):
        ...
        blockhash, = self.nodes[2].generate(1, self.signblockprivkey_wif)
        self.sync_all()
    ...
    def test_reorg(self):
        ...
        lastblockhash = self.nodes[1].generate(6, self.signblockprivkey_wif)[5]
        self.nodes[2].generate(7, self.signblockprivkey_wif)
    ...
    def test_double_spend(self):
        ...
        1. User 1 receives TPC in tx1 from utxo1 in block aa1.
        2. User 2 receives TPC in tx2 from utxo1 (same) in block bb1
        ...
        # generate on both sides
        lastblockhash = self.nodes[1].generate(3, self.signblockprivkey_wif)[2]
