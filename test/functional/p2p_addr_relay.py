...
class AddrTest(BitcoinTestFramework):
    ...
    def oversized_addr_test(self, whitelist=False):
    ...
    def relay_tests(self):
        ...
        inbound_peer = self.nodes[0].add_p2p_connection(AddrReceiver(self.nodes[0].time_to_connect, test_addr_contents=True, send_getaddr=False))
        full_outbound_peer = self.nodes[0].add_outbound_p2p_connection(AddrReceiver(self.nodes[0].time_to_connect), p2p_idx=0, connection_type="outbound-full-relay")
        ...
        block_relay_peer = self.nodes[0].add_outbound_p2p_connection(AddrReceiver(self.nodes[0].time_to_connect), p2p_idx=1, connection_type="block-relay-only")
    ...
    def inbound_blackhole_tests(self):
        ...
        blackhole_peer = self.nodes[0].add_p2p_connection(AddrReceiver(self.nodes[0].time_to_connect, send_getaddr=False))
    ...
    def getaddr_tests(self):
        ...
        inbound_peer = self.nodes[0].add_p2p_connection(AddrReceiver(self.nodes[0].time_to_connect, send_getaddr=False))
    ...
    def rate_limit_tests(self):
        ...
        for conn_type, no_relay in [("outbound-full-relay", False), ("block-relay-only", True), ("inbound", False)]:
            ...
            if conn_type == "inbound":
                ...
                peer = self.nodes[0].add_outbound_p2p_connection(AddrReceiver(self.nodes[0].time_to_connect), p2p_idx=0, connection_type=conn_type)
