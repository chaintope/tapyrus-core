...
class PrioritiseTransactionTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        utxo_count = 90
        utxos = create_confirmed_utxos(self.relayfee, self.nodes[0], utxo_count, self.signblockprivkey_wif)
        ...
        tx_hex = self.nodes[0].signrawtransactionwithwallet(raw_tx, [], "ALL", self.options.scheme)["hex"]
