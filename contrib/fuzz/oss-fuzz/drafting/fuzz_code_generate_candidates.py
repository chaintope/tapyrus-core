...
for -- one YAML per candidate, saved into src/test/fuzz/fuzz_candidates/.
...
src/test/fuzz/fuzz_candidates/ "candidates" because that's what they are from our side
