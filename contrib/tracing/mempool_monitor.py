...
""" Example logging Tapyrus Core mempool events using the mempool:added,
...
def main(bitcoind_path):
    ...
    # to the tracepoints
    bitcoind_with_usdts.enable_probe(probe="added", fn_name="trace_added")
    bitcoind_with_usdts.enable_probe(probe="removed", fn_name="trace_removed")
    bitcoind_with_usdts.enable_probe(probe="replaced", fn_name="trace_replaced")
    bitcoind_with_usdts.enable_probe(probe="rejected", fn_name="trace_rejected")
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("USAGE: ", sys.argv[0], "path/to/tapyrusd")
        exit(1)
