    ...
    platformStyle(_platformStyle)
{
    ...
    connect(ui->treeWidget, &QTreeWidget::customContextMenuRequested, this, &CoinControlDialog::showMenu);
    ...
    connect(ui->radioTreeMode, &QAbstractButton::toggled, this, &CoinControlDialog::radioTreeMode);
    connect(ui->radioListMode, &QAbstractButton::toggled, this, &CoinControlDialog::radioListMode);
