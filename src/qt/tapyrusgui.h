...
#ifndef TAPYRUS_QT_TAPYRUSGUI_H
...
public:
    ...
    explicit TapyrusGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~TapyrusGUI();
...
private:
    ...
    QAction* issueTokenAction = nullptr;
