...
void RPCConsole::setClientModel(ClientModel *model)
{
    ...
    if (model && clientModel->getPeerTableModel() && clientModel->getBanTableModel()) {
        ...
        // Ban time actions with direct connections (Qt 6 doesn't have QSignalMapper::map() slot)
        ...
        connect(model->getPeerTableModel(), &QAbstractItemModel::layoutChanged, this, &RPCConsole::peerLayoutChanged);
        ...
        connect(model->getBanTableModel(), &QAbstractItemModel::layoutChanged, this, &RPCConsole::showOrHideBanTableIfRequired);
        ...
        ui->networkName->setText(QString::fromStdString(FederationParams().NetworkIDString()));
...
void RPCConsole::startExecutor()
{
    ...
    connect(executor, &RPCExecutor::reply, this, [this](int category, const QString &message){
    ...
    connect(&thread, &QThread::finished, executor, &QObject::deleteLater, Qt::DirectConnection);
