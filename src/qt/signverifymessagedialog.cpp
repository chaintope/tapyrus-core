...
void SignVerifyMessageDialog::on_signMessageButton_SM_clicked()
{
    ...
    CTxDestination destination = DecodeDestination(ui->addressIn_SM->text().toStdString(), colorId);
...
{
    ColorIdentifier colorId;
    CTxDestination destination = DecodeDestination(ui->addressIn_VM->text().toStdString(), colorId);
    if (!IsValidDestination(destination)) {
