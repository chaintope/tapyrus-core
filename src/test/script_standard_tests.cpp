...
BOOST_AUTO_TEST_CASE(script_standard_ExtractDestination)
{
    ...
    BOOST_CHECK(std::get<CKeyID>(address) == pubkey.GetID());
    ...
    s << OP_HASH160 << ToByteVector(CScriptID(redeemScript)) << OP_EQUAL;
    BOOST_CHECK(ExtractDestination(s, address));
    BOOST_CHECK(std::get<CScriptID>(address) == CScriptID(redeemScript));
...
BOOST_AUTO_TEST_CASE(script_standard_ExtractDestinations)
{
    ...
    BOOST_CHECK(std::get<CKeyID>(addresses[0]) == pubkeys[0].GetID());
    ...
    BOOST_CHECK(std::get<CKeyID>(addresses[0]) == pubkeys[0].GetID());
    BOOST_CHECK(std::get<CKeyID>(addresses[1]) == pubkeys[1].GetID());
