...
BOOST_AUTO_TEST_CASE(parse_pubkey_string_empty)
{
    ...
    BOOST_CHECK_EXCEPTION(const_cast<CFederationParams&>(FederationParams()).ReadAggregatePubkey(ParseHex(""), 0), std::runtime_error, [] (const std::runtime_error& ex) {
...
BOOST_AUTO_TEST_CASE(parse_pubkey_string_uncompressed)
{
    ...
    BOOST_CHECK_EXCEPTION(const_cast<CFederationParams&>(FederationParams()).ReadAggregatePubkey(ParseHex("046b93737b4e8d93e79464f2054434015326f1834be1ec47e23377a8cc622b94a03f3c58c0c33248e2bb733269751facb479c098eec6ce254e00c7e45c103b7cd7"), 0), std::runtime_error, [] (const std::runtime_error& ex) {
