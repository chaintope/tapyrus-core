...
BOOST_AUTO_TEST_CASE(checkdatasig_test) {
    ...
    CheckError(MANDATORY_SCRISTANDARD_NOT_MANDATORY_VERIFY_FLAGSPT_VERIFY_FLAGS, {{}, message, pubkeyC}, CScript() << OP_CHECKDATASIGVERIFY, SCRIPT_ERR_CHECKDATASIGVERIFY);
