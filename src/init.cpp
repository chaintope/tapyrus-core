...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-signblockpubkeys=<pubkey>", "Sets the aggregate public key for Signed Blocks Proof Verification as a hex string.", false, OptionsCategory::SIGN_BLOCK);
