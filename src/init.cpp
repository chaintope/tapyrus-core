...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-signblockpubkey=<pubkey>", "Sets the aggregate public key for Signed Blocks Proof Verification as a hex string.", false, OptionsCategory::SIGN_BLOCK);
