...
void RegisterValidationInterface(CValidationInterface* pwalletIn) {
    ...
    g_signals.m_internals->NewValidBlock.connect(boost::bind(&CValidationInterface::NewValidBlock, pwalletIn, boost::placeholders::_1, boost::placeholders::_2));
}
...
void UnregisterValidationInterface(CValidationInterface* pwalletIn) {
    ...
    g_signals.m_internals->NewValidBlock.disconnect(boost::bind(&CValidationInterface::NewValidBlock, pwalletIn, boost::placeholders::_1, boost::placeholders::_2));
}
