...
public:
    CProductionChainParams():CChainParams() {
        ...
        base58Prefixes[C_PUBKEY_ADDRESS] = std::vector<unsigned char>(1,16);
        base58Prefixes[C_SCRIPT_ADDRESS] = std::vector<unsigned char>(1,18);
...
public:
    CDevelopmentChainParams():CChainParams() {
        ...
        base58Prefixes[C_PUBKEY_ADDRESS] = std::vector<unsigned char>(1,36);
        base58Prefixes[C_SCRIPT_ADDRESS] = std::vector<unsigned char>(1,38);
