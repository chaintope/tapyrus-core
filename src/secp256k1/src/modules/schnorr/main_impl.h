...
/* Helper function to compute deterministic nonce, k */
...
int secp256k1_schnorr_verify(
    ...
    /* Compute e */
    secp256k1_schnorr_compute_e(&e, sig64, &q, msg32);

    /* Verify the signature */
    secp256k1_scalar_negate(&e, &e);
    secp256k1_gej_set_ge(&Pj, &q);
    secp256k1_ecmult(&ctx->ecmult_ctx, &Rj, &Pj, &e, &s);
...
int secp256k1_schnorr_sign(
    ...
    secp256k1_scalar privkey, e, s, k;
    ...
    if (!secp256k1_schnorr_sig_generate_k(&k, msg32, seckey, noncefp, ndata)) {
        secp256k1_scalar_clear(&k);
        return 0;
    }

    secp256k1_pubkey_load(ctx, &p, &pubkey);
    secp256k1_scalar_set_b32(&privkey, seckey, NULL);
    ...
    secp256k1_schnorr_compute_e(&e, sig64, &p, msg32);
